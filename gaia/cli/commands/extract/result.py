...
_RESULT_EPILOG = (
    ...
    "A succeeded envelope also carries `task_id`, `status`, `cache_hit`, "
    "`cache_source`, and `step_durations`. Status responses do not include "
    "the cache fields.\n\n"
    ...
    "a non-retryable business failure; do not resubmit the same PDF or "
    "`--content` body. Empty `files` on partial is expected.\n\n"
