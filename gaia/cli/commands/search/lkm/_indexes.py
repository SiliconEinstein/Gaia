...
The CLI treats an LKM backend like uv treats a package index: users select a
stable index name (``bohrium``), while Gaia resolves that name to a base URL
and keeps credentials out of source refs.
"""
