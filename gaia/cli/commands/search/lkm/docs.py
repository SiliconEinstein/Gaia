...
APIFOX_FEEDBACK_URL = f"{APIFOX_BASE_URL}/api-474487249"
PAPERS_REFERENCE_PATH = "POST /papers/reference"
ENDPOINT_DOCS: tuple[tuple[str, str], ...] = (
    ...
    ("paper reference lookup", PAPERS_REFERENCE_PATH),
