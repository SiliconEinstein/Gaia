...
STRUCTURAL_EXPRESSION_HELPER_KINDS = frozenset(
    {
        "negation_result",
        "conjunction_result",
        "disjunction_result",
...
def is_structural_expression_helper(knowledge: "Knowledge") -> bool:
    """Return True for non-reviewable helper claims generated by ~, &, and |."""
    metadata = knowledge.metadata or {}
    return (
        knowledge.type == KnowledgeType.CLAIM
        and metadata.get("generated") is True
        and metadata.get("review") is False
        and metadata.get("helper_kind") in STRUCTURAL_EXPRESSION_HELPER_KINDS
    )
