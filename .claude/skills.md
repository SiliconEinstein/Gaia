...
This file is the agent-facing skills catalog for this repo. Skill bodies live under `.claude/skills/<skill-name>/SKILL.md`. Claude Code discovers them natively; AGENTS-aware agents read this index.
