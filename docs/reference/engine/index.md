...
stable public names without depending on internal file layout. The 221
...
| [lang](lang.md) | 94 | Top-level imports exposed to package authors — claims, actions, relations, formula helpers, distribution factories (`Normal`, `Binomial`, `BetaBinomial`, ...), and runtime entities |
...
**Grand total: 221 symbols across 7 facades.**
