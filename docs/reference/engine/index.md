...
stable public names without depending on internal file layout. The 223
...
| [lang](lang.md) | 96 | Top-level imports exposed to package authors — claims, actions, artifact note anchors (`artifact`, `figure`), relations, formula helpers, distribution factories (`Normal`, `Binomial`, `BetaBinomial`, ...), and runtime entities |
...
**Grand total: 223 symbols across 7 facades.**
