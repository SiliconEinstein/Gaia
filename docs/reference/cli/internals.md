...
CLI behavior is documented in [CLI Workflow Command Guide](../../for-users/cli-commands.md);
...
v0.5 surface also includes `gaia sdk` as the primary SDK-reference entrypoint
plus optional helper surfaces such as `author`, `bayes`, `pkg add-import`,
`pkg add-module`, and `pkg scaffold`. See
[Migration to alpha 0](../../releases/migration-alpha-0.md) for the old-to-new verb mapping
