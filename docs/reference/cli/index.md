...
| [search](search.md) | `lkm [knowledge\|reasoning\|reasoning-search\|variables\|paper-graph\|auth]` | Retrieve remote knowledge candidates for Gaia authoring; future home for local package search |
