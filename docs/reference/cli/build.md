...
gaia build check [path]     Validate structure, priors, warrants, and refs
```
...
| `check` | Validate `pyproject.toml`, IR hash, schema, naming, priors, warrants, reference/citation/artifact diagnostics, and quality gate |
