...
**Date**: 2026-05-24
**Status**: Implemented — verb-boundary lift landed in #706 (`feat(lang): lift Boolean-valued expressions to Claim at verb boundaries (#703)`); extended to `associate` / `decompose` / `depends_on` / `candidate_relation` in #712
