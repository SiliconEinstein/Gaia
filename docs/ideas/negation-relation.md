...
其中 ε = Cromwell 下界（见 [04-belief-propagation.md](../foundations/theory/04-belief-propagation.md)）。
...
- [../foundations/theory/02-reasoning-factor-graph.md](../foundations/theory/02-reasoning-factor-graph.md) — 因子图逻辑算子（当前缺少否定）
