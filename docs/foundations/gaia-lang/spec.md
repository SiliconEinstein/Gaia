...
Setting 不携带 prior，不参与 BP。可作为 factor 的承载性前提（structural dependency），但不创建 BP 边。对齐 [science-ontology.md §1.2](../theory/science-ontology.md) 和 [graph-ir.md §1.2](../graph-ir/graph-ir.md)。
...
参见 [coarse-reasoning.md](../theory/coarse-reasoning.md) 和 [science-formalization.md §2.4](../theory/science-formalization.md)。
