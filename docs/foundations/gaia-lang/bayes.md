...
`gaia.engine.bayes` is the only v0.5 Bayes module path; the earlier
`gaia.engine.lang.bayes` development path and `from gaia.engine.lang import
bayes` shortcut were removed before v0.5 release.
