...
| **Registry** | GitHub 仓库（Julia General 模型），注册/canonicalization/BP 通过 CI workflow |
...
| **LKM 全局 BP** | 服务端 BPService | 全局规范图 | 十亿节点规模的完整证据汇聚 |
...
| 矛盾检测 | contradiction Operator → BP 压低双方 belief |
