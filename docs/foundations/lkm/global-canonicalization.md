...
关于规范化身份模型（raw、local canonical、global canonical），参见 [../gaia-ir/05-canonicalization.md](../gaia-ir/05-canonicalization.md)。
...
关于 factor node schema，参见 [../gaia-ir/02-gaia-ir.md](../gaia-ir/02-gaia-ir.md)。
