...
- `gaia/ir/knowledge.py` -- `Knowledge`, `KnowledgeType`, `make_qid`, `is_qid`
- `gaia/ir/graphs.py` -- `LocalCanonicalGraph`
- `gaia/ir/operator.py` -- `Operator`, `OperatorType`
- `gaia/ir/strategy.py` -- `Strategy`, `CompositeStrategy`, `FormalStrategy`, `FormalExpr`, `StrategyType`
- `gaia/ir/formalize.py` -- `formalize_named_strategy`, `FormalizationResult`
- `gaia/ir/parameterization.py` -- `PriorRecord`, `ParameterizationSource`
- `gaia/ir/validator.py` -- `validate_local_graph`, `validate_parameterization`
