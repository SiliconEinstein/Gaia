...
- `gaia/engine/ir/knowledge.py` -- `Knowledge`, `KnowledgeType`, `make_qid`, `is_qid`
- `gaia/engine/ir/graphs.py` -- `LocalCanonicalGraph`
- `gaia/engine/ir/operator.py` -- `Operator`, `OperatorType`
- `gaia/engine/ir/strategy.py` -- `Strategy`, `CompositeStrategy`, `FormalStrategy`, `FormalExpr`, `StrategyType`
- `gaia/engine/ir/formalize.py` -- `formalize_named_strategy`, `FormalizationResult`
- `gaia/engine/ir/parameterization.py` -- `PriorRecord`, `ParameterizationSource`
