...
to satisfy the GraphStore ABC. This is fine for single-process CLI usage.
"""
...
class KuzuGraphStore(GraphStore):
    ...
    async def get_subgraph(
        ...
        One knowledge hop = Proposition -> Hyperedge -> Proposition.
        We expand iteratively so that edge-type filtering is applied at every step.
        """
        ...
        for _ in range(hops):
            ...
            # Collect connected proposition nodes from discovered edges
